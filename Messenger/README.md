...
JavaScript is injected at document creation and polls the DOM every minute, scanning for language-specific accessibility strings that Facebook injects for screen readers:
